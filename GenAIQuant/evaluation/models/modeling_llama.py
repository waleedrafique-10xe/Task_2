...
class EagerAttention(nn.Module):
    def __init__(self):
        ...
        self.qkt = PassThrough()
        self.rot_embedding_q = PassThrough()
        self.rot_embedding_k = PassThrough()
        self.masked_qkt = PassThrough()
        self.softmax = PassThrough()
        self.attn_output = PassThrough()
    ...
    def forward(
        ...
        **kwargs,
        ...
        # ==================== MOD BLOCK ==================
        attn_weights = self.qkt(attn_weights)
        # ==================== MOD BLOCK ==================
        ...
        # ==================== MOD BLOCK ==================
        attn_weights = self.masked_qkt(attn_weights)
        # ==================== MOD BLOCK ==================
...
class LlamaAttention(nn.Module):
    ...
    def __init__(self, config: LlamaConfig, layer_idx: int):
        ...
        self.eager_attention = EagerAttention()
        # ==================== MOD BLOCK ==================
    ...
    def forward(
        ...
        **kwargs: Unpack[FlashAttentionKwargs],
        ...
        # ==================== MOD BLOCK ==================
        query_states = self.rot_embedding_q(query_states)
        key_states = self.rot_embedding_k(key_states)
        # ==================== MOD BLOCK ==================
        ...
        if attention_interface == eager_attention_forward:
            attention_interface = self.eager_attention
        ...
        # attn_output already quantized in the updated attention interface
...
class LlamaDecoderLayer(GradientCheckpointingLayer):
    def __init__(self, config: LlamaConfig, layer_idx: int):
        ...
        # ==================== MOD BLOCK ==================
        self.attn_residue = PassThrough()
        self.mlp_residue = PassThrough()
        # ==================== MOD BLOCK ==================
    ...
    def forward(
        ...
        **kwargs: Unpack[FlashAttentionKwargs],
        ...
        # ==================== MOD BLOCK ==================
        hidden_states = self.attn_residue(hidden_states)
        # ==================== MOD BLOCK ==================
        ...
        # ==================== MOD BLOCK ==================
        hidden_states = self.mlp_residue(hidden_states)
        # ==================== MOD BLOCK ==================
